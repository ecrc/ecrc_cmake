#+TITLE: HICMA CMake "Find modules" documentation
#+AUTHOR: HiePACS
#+LANGUAGE:  en
...
This document aims at documenting HICMA find_package CMake modules
...
To use HICMA modules you can add the path to the modules in your CMake
project like this
#+BEGIN_EXAMPLE
list(APPEND CMAKE_MODULE_PATH "${HICMA_DISTRIB_DIR}/cmake_modules/hicma/find" )
#+END_EXAMPLE
