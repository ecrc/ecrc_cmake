...
if( (NOT PKG_CONFIG_EXECUTABLE) OR (PKG_CONFIG_EXECUTABLE AND NOT HICMA_FOUND) OR (HICMA_GIVEN_BY_USER) )
  ...
  if(HICMA_INCDIR)
    set(HICMA_hicma.h_DIRS "HICMA_hicma.h_DIRS-NOTFOUND")
    find_path(HICMA_hicma.h_DIRS
      NAMES hicma.h
      HINTS ${HICMA_INCDIR})
  else()
    if(HICMA_DIR)
  ...
  mark_as_advanced(HICMA_hicma.h_DIRS)

  # If found, add path to cmake variable
  # ------------------------------------
  if (HICMA_hicma.h_DIRS)
    set(HICMA_INCLUDE_DIRS "${HICMA_hicma.h_DIRS}")
  else ()
